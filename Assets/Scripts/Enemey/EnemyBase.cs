...
public class EnemyBase : PhysicsObject
{
	  ...
	  protected override void ComputeVelocity()
    {
		...
		playerDifference = player.transform.position.x - this.transform.position.x;
		...
		if (followPlayer) {
			...
			Debug.DrawRay (new Vector2 (transform.position.x, transform.position.y + rayCastOffset.y), Vector2.right, Color.yellow, 100f);
	...
	public void Hit(int launchDirection){
		// PlayerPlatformerController.Instance.cameraEffect.Shake (100,1);
		health -= 1;
